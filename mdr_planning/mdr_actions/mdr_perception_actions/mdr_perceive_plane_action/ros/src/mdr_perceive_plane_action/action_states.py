...
from mas_perception_libs import ObjectDetector
from mas_perception_libs import Constant, ImageRecognitionServiceProxy
...
class RecognizeObjects(smach.State):
    ...
    def execute(self, ud):
        ...
        for plane in ud.detected_planes.planes:
            ...
            indices, classes, probs = self._service_proxy.classify_image_list(image_messages)
