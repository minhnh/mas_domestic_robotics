...
class SimplePickup:
    ...
    def __init__(self):
        ...
        self.server = actionlib.SimpleActionServer('pickup_server', PickUpAction, self.execute, False)
        self.server.start()
    ...
    def execute(self, goal):
        ...
        goal.position.point.y += 0.05

        # pre-calculate the trajectory to the position
        traj = self.plan_trajectory(goal.position)
